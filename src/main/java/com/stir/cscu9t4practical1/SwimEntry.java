...
public class SwimEntry extends Entry
{
	...
	{
		super(n, d, m, y, h, min, s, dist); this.where = where;
	}
	...
	@Override public String getEntry()
	{
		...
		{
			result = getName() + " swam " + getDistance() + " km in a " + getWhere() + " in " + getHour() + ":"
		...
		{
			result = getName() + " swam " + getDistance() + " km " + getWhere() + " in " + getHour() + ":"
					+ getMin() + ":" + getSec() + " on " + getDay() + "/" + getMonth() + "/" + getYear() + "\n";
		}
